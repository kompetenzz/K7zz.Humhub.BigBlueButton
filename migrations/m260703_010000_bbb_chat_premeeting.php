 ...
 *
 * Pre-meeting messages have session_meeting_id = NULL and reference the session
...
class m260703_010000_bbb_chat_premeeting extends Migration
{
    ...
    {
        // Make session_meeting_id nullable (pre-meeting messages have no meeting yet)
        $this->alterColumn('bbb_session_meeting_chat', 'session_meeting_id', $this->integer()->null());

        // Add direct session reference for pre-meeting messages
